...
import {
  ...
  TextInput, ActivityIndicator, Modal, Switch, Keyboard,
} from 'react-native';
            ...
            <TouchableOpacity key={service.id} style={s.card} onPress={() => openEdit(service)} activeOpacity={0.75}>
              <View style={s.cardLeft}>
                <View style={s.cardIcon}>
                  <MaterialIcons name="content-cut" size={20} color="#10B981" />
                </View>
              ...
              <View style={s.cardRight}>
                ...
                <TouchableOpacity
                  style={s.deleteBtn}
                  onPress={() => setDeleteConfirm(service)}
          ...
          <View style={s.modalSheet}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={s.modalScroll} keyboardShouldPersistTaps="handled">
              ...
              <TextInput
                ...
                placeholder="Ej: Corte de cabello, Manicure, Masaje..."
              ...
              <View style={s.priceRow}>
                ...
                <TextInput
                  style={[s.fieldInput, s.fieldPrice]}
                  value={price}
              ...
              <View style={s.durationGrid}>
                {DURATION_OPTIONS.map(min => (
                  <TouchableOpacity
                    key={min}
                    style={[s.durationBtn, durationMinutes === min && s.durationBtnActive]}
                    onPress={() => setDurationMinutes(min)}
                  >
                    <Text style={[s.durationBtnText, durationMinutes === min && s.durationBtnTextActive]}>
                      {durationLabel(min)}
                    </Text>
                  </TouchableOpacity>
                ))}
              ...
              >
                {saving
                  ...
                  : <Text style={s.saveBtnText}>{editingService ? 'Guardar cambios' : 'Agregar servicio'}</Text>
                }
              </TouchableOpacity>

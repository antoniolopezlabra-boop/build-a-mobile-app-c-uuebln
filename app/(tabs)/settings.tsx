    ...
    <SafeAreaView style={[s.container, { backgroundColor: tc.bg }]}>
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <SettingGroup title="MI NEGOCIO">
          ...
          <SettingRow iconName="work-outline" iconColor="#F59E0B" iconBg="#FFFBEB" label="Catálogo de servicios" sublabel="Gestiona tus servicios y precios" onPress={() => router.push('/settings/services')} />
